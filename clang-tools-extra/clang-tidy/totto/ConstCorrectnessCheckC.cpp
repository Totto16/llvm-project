...
ConstCorrectnessCheckC::ConstCorrectnessCheckC(StringRef Name,
  ...
  if (AnalyzeValues == false && AnalyzeReferences == false &&
    ...
    this->configurationDiag(
        "The check 'totto-const-correctness-c' will not "
        "perform any analysis because 'AnalyzeValues', "
        "'AnalyzeReferences' and 'AnalyzePointers' are false.");
}

void ConstCorrectnessCheckC::storeOptions(ClangTidyOptions::OptionMap &Opts) {
...
void ConstCorrectnessCheckC::registerMatchers(MatchFinder *Finder) {
...
void ConstCorrectnessCheckC::check(const MatchFinder::MatchResult &Result) {
...
void ConstCorrectnessCheckC::registerScope(const Stmt *LocalScope,
                                          ASTContext *Context) {
...
bool ConstCorrectnessCheckC::isMutated(const VarDecl *Variable,
                                      const Stmt *Scope,
